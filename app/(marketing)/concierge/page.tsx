...
export default function ConciergeModel() {
  return (
    <div className="px-12 py-28 max-w-[1200px]">
      <div className="label">The practice &middot; The concierge model</div>
      <h1 className="mt-6 font-display text-[56px] leading-[1.04] tracking-[-0.015em] font-normal text-ink max-w-[860px]">
      ...
      <p className="mt-10 text-[16px] leading-[1.7] text-ink-soft max-w-[760px]">
      ...
      <blockquote className="pull mt-12 max-w-[760px]">
        The white-glove is not an option. It is the product.
      </blockquote>

      {/* The split */}
      <section className="mt-28 grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-14">
        {/* What we handle */}
        <div>
          <div className="label">What Atrium handles</div>
          <h2 className="mt-3 font-display text-[28px] leading-[1.12] tracking-[-0.005em] font-normal text-ink">
        ...
        <div>
          ...
          <div className="mt-10 sticky top-12">
            <ol className="space-y-9">
              {FAMILY_SEES.map((item, i) => (
                <li key={item} className="border-l-2 border-copper pl-7 py-1">
                  <div className="font-mono text-[10px] tracking-[0.22em] uppercase text-copper">
                    Step {String(i + 1).padStart(2, "0")}
                  </div>
                  <div className="mt-2 font-display text-[20px] leading-[1.3] tracking-[-0.005em] text-ink">
                    {item}.
                  </div>
                </li>
              ))}
            ...
            <div className="mt-12 border border-rule bg-paper-card px-7 py-6">
      ...
      <section className="mt-32 border-t border-rule pt-16">
        ...
        <h2 className="mt-3 font-display text-[34px] leading-[1.1] tracking-[-0.005em] font-normal text-ink max-w-[760px]">
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-4 gap-10">
          <Phase
            ...
            body="A 60-minute call with the principal, an heir, or the family-office director. We listen. We tell you in writing whether there is fit."
          />
          <Phase
            num="02"
            tag="Week 1"
            title="The diagnostic"
            body="Five business days. We map your operational stack, sketch your schema, surface three highest-leverage interventions. Fixed fee. Convertible."
          />
          <Phase
            num="03"
            tag="Weeks 2 — 7"
            title="The install"
            body="Six weeks. We provision the repository, write the schema, capture the founder&rsquo;s reasoning, onboard the first three areas of the house. You read drafts. You approve framings. You sign off."
          />
          <Phase
            num="04"
            tag="Ongoing"
            title="The partnership"
            body="Monthly retainer. Schema maintenance, lint reviews, ingest service, monthly synthesis pass, the weekly briefing, executive coaching when you want it. The compounding case begins here."
          />
        </div>
      </section>

      {/* The operator's working day — quietly explicit */}
      <section className="mt-32 border-t border-rule pt-16">
        <div className="label">A working day at Atrium</div>
        <h2 className="mt-3 font-display text-[28px] leading-[1.12] tracking-[-0.005em] font-normal text-ink max-w-[760px]">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-5 gap-5 max-w-[1000px]">
          {[
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-[860px] text-[14px] leading-[1.7] text-ink-soft">
      ...
      <section className="mt-32 border-t border-rule pt-14">
        <h2 className="font-display text-[28px] leading-[1.12] tracking-[-0.005em] font-normal text-ink max-w-[760px]">
          The technical complexity is invisible by design.
        </h2>
        <p className="mt-6 text-[16px] leading-[1.7] text-ink-soft max-w-[760px]">
        ...
        <p className="mt-4 text-[16px] leading-[1.7] text-ink-soft max-w-[760px]">
